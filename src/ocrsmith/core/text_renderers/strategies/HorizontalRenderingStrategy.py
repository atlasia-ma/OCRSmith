...
class HorizontalRenderingStrategy(BaseTextRenderingStrategy):
    def render_text(self, font: FreeTypeFont, text: str, spacing: int = 1,
                   text_color: str ="#000000", stroke_width: int= 0, stroke_fill: str = "#282828", render_one_line = False, align = "right", fit: bool = True,
                   max_width: int = None, max_height: int = None, min_width: int = None, min_height: int = None) -> tuple:
