...
class FontLoader:
    @staticmethod
    def create_font(font_path: str | Path, size: int, use_cache: bool = True) -> FreeTypeFont:
        ...
        try:
            ...
            raise ValueError(f"Unable to load font from '{font_path}': {e}") from e
    ...
    def create_default_font(size: int = 32) -> FreeTypeFont:
        try:
            ...
            try:
                ...
                raise ValueError("Unable to load any default font") from None
