...
if __name__ == "__main__":
    ...
    from .strategies import GradientBackground, ImageBackground, SolidColorBackground, TextureBackground
    ...
    gradient_img = context.render(
        800, 600, start_color=(255, 0, 0), end_color=(0, 0, 255), direction="horizontal"
    )

    # 4. Texture Background
    texture_strategy = TextureBackground()
    context.set_strategy(texture_strategy)
    texture_img = context.render(800, 600, base_color=(200, 200, 200), noise_level=10)
    texture_img.show()
